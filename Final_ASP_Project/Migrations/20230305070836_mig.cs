        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    book_urlImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    genre_Id = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Carts_ShoppingCart_ShoppingCartId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "9f76b5f3-8a27-4340-ae7f-3cbaeec33f0c", "Admin", "Admin" },
                    { "2", "5042ec6d-692a-4413-927f-477e30a455ea", "Owner", "Owner" },
                    { "3", "abd67a2a-2071-4827-be32-5a837dc37799", "Customer", "Customer" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "Address", "ConcurrencyStamp", "DoB", "Email", "EmailConfirmed", "FullName", "Gender", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "1", 0, "CAN THO", "070893b1-72ef-479a-8965-84e7a1d4cf9a", new DateTime(2002, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@gmail.com", true, "ADMIN PROJECT", "M", false, null, "ADMIN@EXAMPLE.COM", "ADMIN@EXAMPLE.COM", "AQAAAAEAACcQAAAAEJhG1i84hGXwMpzEuMiIQBmDflV6JpFqCo6/P9EfSkWEBLboIaOs1R61rL+8XnbklA==", null, false, "", false, "admin@gmail.com" });
